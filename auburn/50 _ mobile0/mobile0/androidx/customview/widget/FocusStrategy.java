...
class FocusStrategy
{
    ...
    private static boolean isCandidate(final Rect rect, final Rect rect2, final int n) {
        ...
        boolean b4 = true;
        if (n == 17) {
            return (rect.right > rect2.right || rect.left >= rect2.right) && rect.left > rect2.left && b3;
        }
        if (n == 33) {
            return (rect.bottom > rect2.bottom || rect.top >= rect2.bottom) && rect.top > rect2.top && b2;
        }
        if (n == 66) {
            return (rect.left < rect2.left || rect.right <= rect2.left) && rect.right < rect2.right && b;
        }
        if (n == 130) {
