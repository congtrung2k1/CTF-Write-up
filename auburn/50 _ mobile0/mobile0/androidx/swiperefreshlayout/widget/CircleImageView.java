...
class CircleImageView extends ImageView
{
    ...
    private class OvalShadow extends OvalShape
    {
        ...
        private void updateRadialGradient(final int n) {
            final RadialGradient radialGradient = new RadialGradient((float)(n / 2), (float)(n / 2), (float)CircleImageView.this.mShadowRadius, new int[] { 1023410176, 0 }, (float[])null, Shader$TileMode.CLAMP);
