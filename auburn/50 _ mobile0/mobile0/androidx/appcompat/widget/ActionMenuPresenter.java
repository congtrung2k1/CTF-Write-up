...
class ActionMenuPresenter extends BaseMenuPresenter implements SubUiVisibilityListener
{
    ...
    public boolean flagActionItems() {
        ...
        if (this.mStrictWidthLimit) {
            ...
            n8 = mActionItemWidthLimit / mMinCellSize;
            n7 = mMinCellSize + mActionItemWidthLimit % mMinCellSize / n8;
        }
        int j = 0;
        int n9 = n3;
        ...
        while (j < size) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                Label_0497: {
                    if (n6 > 0 || value) {
                        if (n10 > 0 && (!this.mStrictWidthLimit || n8 > 0)) {
                            isActionButton = true;
                            break Label_0497;
                        }
                    }
                ...
                if (isActionButton) {
                    ...
                    if (this.mStrictWidthLimit) {
                        isActionButton &= (n10 >= 0);
                    }
                    else {
                        isActionButton &= (n10 + n14 > 0);
                    }
                }
                else {
                    n14 = n9;
