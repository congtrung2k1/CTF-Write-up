    ...
    static class GestureDetectorCompatImplBase implements GestureDetectorCompatImpl
    {
        ...
        public boolean onTouchEvent(MotionEvent mPreviousUpEvent) {
            ...
            if (n6 != 0) {
                    ...
                    if (n6 != 2) {
                        ...
                        if (this.mAlwaysInTapRegion) {
                            ...
                            if (n9 > this.mTouchSlopSquare) {
                                b5 = this.mListener.onScroll(this.mCurrentDownEvent, mPreviousUpEvent, a, a2);
                                this.mLastFocusX = n4;
                                this.mLastFocusY = n5;
                                this.mAlwaysInTapRegion = false;
                                this.mHandler.removeMessages(3);
                    ...
                    if (this.mDoubleTapListener != null) {
                        ...
                        if (mCurrentDownEvent != null) {
                            ...
                            if (mPreviousUpEvent2 != null && hasMessages && this.isConsideredDoubleTap(mCurrentDownEvent, mPreviousUpEvent2, mPreviousUpEvent)) {
                                ...
                                b7 = (this.mDoubleTapListener.onDoubleTap(this.mCurrentDownEvent) | false | this.mDoubleTapListener.onDoubleTapEvent(mPreviousUpEvent));
                                break Label_1043;
                            }
                        }
                ...
                b5 = (b7 | this.mListener.onDown(mPreviousUpEvent));
            }
            return b5;
        }
