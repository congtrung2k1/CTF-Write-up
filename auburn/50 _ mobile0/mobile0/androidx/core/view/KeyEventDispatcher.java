...
public class KeyEventDispatcher
{
    ...
    private static boolean actionBarOnMenuKeyEventPre28(final ActionBar obj, final KeyEvent keyEvent) {
        if (!KeyEventDispatcher.sActionBarFieldsFetched) {
            try {
                KeyEventDispatcher.sActionBarOnMenuKeyMethod = obj.getClass().getMethod("onMenuKeyEvent", KeyEvent.class);
            }
        ...
        if (sActionBarOnMenuKeyMethod != null) {
            try {
                return (boolean)sActionBarOnMenuKeyMethod.invoke(obj, keyEvent);
            }
    ...
    private static DialogInterface$OnKeyListener getDialogKeyListenerPre28(final Dialog obj) {
        ...
        if (sDialogKeyListenerField != null) {
            try {
                return (DialogInterface$OnKeyListener)sDialogKeyListenerField.get(obj);
            }
