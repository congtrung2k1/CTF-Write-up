    ...
    private static boolean ensureActionReflectionReadyLocked() {
        ...
        try {
            if (NotificationCompatJellybean.sActionsField == null) {
                NotificationCompatJellybean.sActionIconField = (NotificationCompatJellybean.sActionClass = Class.forName("android.app.Notification$Action")).getDeclaredField("icon");
            ...
            Label_0121: {
                try {
                    ...
                    if (actionObjectsLocked != null) {
                        ...
                        return readAction(NotificationCompatJellybean.sActionIconField.getInt(obj), (CharSequence)NotificationCompatJellybean.sActionTitleField.get(obj), (PendingIntent)NotificationCompatJellybean.sActionIntentField.get(obj), bundle2);
                    }
                    break Label_0121;
                }
                finally {
