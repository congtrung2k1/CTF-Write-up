...
public class NotificationCompat
{
    ...
    public static class Action
    {
        ...
        Action(final int icon, final CharSequence charSequence, final PendingIntent actionIntent, final Bundle bundle, final RemoteInput[] mRemoteInputs, final RemoteInput[] mDataOnlyRemoteInputs, final boolean mAllowGeneratedReplies, final int mSemanticAction, final boolean mShowsUserInterface) {
    ...
    public static class Builder
    {
        ...
        private Bitmap reduceLargeIconSize(final Bitmap bitmap) {
            ...
            Double.isNaN(v6);
            return Bitmap.createScaledBitmap(bitmap, n, (int)Math.ceil(v6 * min), true);
        }
        ...
        public RemoteViews applyStandardTemplate(final boolean b, int n, final boolean b2) {
            ...
            if (this.mBuilder.mLargeIcon != null) {
                ...
                if (Build$VERSION.SDK_INT >= 21) {
                    ...
                    final int dimensionPixelSize3 = resources.getDimensionPixelSize(R.dimen.notification_big_circle_margin);
                    n = resources.getDimensionPixelSize(R.dimen.notification_small_icon_size_as_large);
                    remoteViews.setImageViewBitmap(R.id.icon, this.createIconWithBackground(this.mBuilder.mNotification.icon, dimensionPixelSize2 - dimensionPixelSize3, n, this.mBuilder.getColor()));
                }
                else {
