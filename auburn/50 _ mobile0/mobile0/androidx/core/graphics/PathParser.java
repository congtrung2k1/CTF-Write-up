    ...
    public static class PathDataNode
    {
        ...
        private static void addCommand(final Path path, final float[] array, final char c, final char c2, final float[] array2) {
            ...
            while (i < array2.length) {
                ...
                if (c2 != 'A') {
                    if (c2 != 'C') {
                        if (c2 != 'H') {
                            if (c2 != 'Q') {
                                        ...
                                        if (c2 != 'c') {
                                            if (c2 != 'h') {
                                                if (c2 != 'q') {
                                                            ...
                                                            if (c2 != 'M') {
                                                                if (c2 != 'S') {
                                                                    if (c2 != 'T') {
                                                                        ...
                                                                        path.quadTo(n30, n31, array2[i + 0], array2[i + 1]);
                                                                        n14 = array2[i + 0];
                                                                        n12 = array2[i + 1];
                                                                        final float n32 = n30;
                                                                        n16 = n31;
                                                    ...
                                                    final float n37 = n14 + array2[i + 2];
                                                    final float n38 = array2[i + 3];
                                                    final float n39 = n35 + n14;
                                                    n16 = n12 + n36;
                                                    n12 += n38;
                                                    n14 = n37;
                                                    n15 = n39;
                                            ...
                                            final float n42 = n14 + array2[i + 4];
                                            final float n43 = array2[i + 5];
                                            final float n44 = n40 + n14;
                                            n16 = n12 + n41;
                                            n12 += n43;
                                            n14 = n42;
                                            n15 = n44;
                                ...
                                final int n52 = i;
                                path.quadTo(array2[n52 + 0], array2[n52 + 1], array2[n52 + 2], array2[n52 + 3]);
                                n15 = array2[n52 + 0];
                                n16 = array2[n52 + 1];
                                n14 = array2[n52 + 2];
                                n12 = array2[n52 + 3];
                        ...
                        final int n54 = i;
                        path.cubicTo(array2[n54 + 0], array2[n54 + 1], array2[n54 + 2], array2[n54 + 3], array2[n54 + 4], array2[n54 + 5]);
                        n14 = array2[n54 + 4];
                        n12 = array2[n54 + 5];
                        n15 = array2[n54 + 2];
                        n16 = array2[n54 + 3];
                    ...
                    final int n55 = i;
                    drawArc(path, n14, n12, array2[n55 + 5], array2[n55 + 6], array2[n55 + 0], array2[n55 + 1], array2[n55 + 2], array2[n55 + 3] != 0.0f, array2[n55 + 4] != 0.0f);
                    n15 = array2[n55 + 5];
                    n16 = array2[n55 + 6];
                    n14 = n15;
                    n12 = n16;
        ...
        private static void arcToBezier(final Path path, final double n, final double n2, final double n3, final double n4, double n5, double n6, double cos, double n7, double n8) {
            ...
            while (i < n9) {
                ...
                final double sin3 = Math.sin(n17);
                final double cos3 = Math.cos(n17);
                final double n18 = n + n3 * n6 * cos3 - n4 * n5 * sin3;
                final double n19 = n2 + n3 * n5 * cos3 + n4 * n6 * sin3;
                final double n20 = -n3 * n6 * sin3 - n4 * n5 * cos3;
                final double n21 = -n3 * n5 * sin3 + n4 * n6 * cos3;
                final double tan = Math.tan((n17 - n15) / 2.0);
                final double n22 = Math.sin(n17 - n15) * (Math.sqrt(tan * 3.0 * tan + 4.0) - 1.0) / 3.0;
                path.rLineTo(0.0f, 0.0f);
                path.cubicTo((float)(n13 + n22 * n14), (float)(n8 + n22 * n11), (float)(n18 - n22 * n20), (float)(n19 - n22 * n21), (float)n18, (float)n19);
                n15 = n17;
                n8 = n19;
                n14 = n20;
                n11 = n21;
        ...
        private static void drawArc(final Path path, final float n, final float n2, final float n3, final float n4, final float n5, final float n6, final float n7, final boolean b, final boolean b2) {
            ...
            final double v3 = n5;
            Double.isNaN(v3);
            final double n8 = (v * cos + v2 * sin) / v3;
            final double v4 = -n;
            Double.isNaN(v4);
            final double v5 = n2;
            Double.isNaN(v5);
            final double v6 = n6;
            Double.isNaN(v6);
            final double n9 = (v4 * sin + v5 * cos) / v6;
            final double v7 = n3;
            Double.isNaN(v7);
            final double v8 = n4;
            Double.isNaN(v8);
            final double v9 = n5;
            Double.isNaN(v9);
            final double n10 = (v7 * cos + v8 * sin) / v9;
            final double v10 = -n3;
            Double.isNaN(v10);
            final double v11 = n4;
            Double.isNaN(v11);
            final double v12 = n6;
            Double.isNaN(v12);
            final double n11 = (v10 * sin + v11 * cos) / v12;
            ...
            final double v13 = n5;
            Double.isNaN(v13);
            final double n24 = n20 * v13;
            final double v14 = n6;
            Double.isNaN(v14);
            final double n25 = v14 * n21;
