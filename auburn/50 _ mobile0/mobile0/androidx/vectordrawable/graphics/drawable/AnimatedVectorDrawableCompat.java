...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat
{
    ...
    public static AnimatedVectorDrawableCompat create(final Context context, int next) {
        if (Build$VERSION.SDK_INT >= 24) {
    ...
    private static void registerPlatformCallback(final AnimatedVectorDrawable animatedVectorDrawable, final AnimationCallback animationCallback) {
    ...
    @Override
    public boolean unregisterAnimationCallback(final AnimationCallback o) {
        if (this.mDelegateDrawable != null) {
