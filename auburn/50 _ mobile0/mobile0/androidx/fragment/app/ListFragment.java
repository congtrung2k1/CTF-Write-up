    ...
    private void ensureList() {
        ...
        if (view != null) {
            if (view instanceof ListView) {
                ...
                final TextView mStandardEmptyView = (TextView)view.findViewById(16711681);
                if ((this.mStandardEmptyView = mStandardEmptyView) == null) {
                ...
                if (!(viewById instanceof ListView)) {
                    ...
                    final ListView mList = (ListView)viewById;
                    this.mList = mList;
